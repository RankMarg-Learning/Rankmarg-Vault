...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-16 z-40 h-[calc(100vh-4rem)] w-72 border-r border-border bg-sidebar transition-transform duration-300 md:translate-x-0',
        ...
        <ScrollArea className="h-full py-4">
          <div className="px-3 mb-4">
            <div className="flex items-center gap-2 px-3 py-2 bg-primary/10 rounded-lg">
              ...
              <span className="font-semibold text-sidebar-foreground">{selectedExam} Vault</span>
            </div>
          </div>
